...
## Class diagram
I have not included all getters and setters in the following class diagram in order to improve readability. Other than that, all methods are included. 

![diagram](/img/classdiagram.jpg)


If I were to extend my application I would implement a flexible way of searching for members and boats. For example, it would be useful to be able to search for a boat and the boat's owner.  
